  ...
  \cventry
    ...
    {Feb. 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Provided on-call support for Critcal Application Services}
        ...
        \item {Subject Matter Expert for firm's GitLab deployment running on-prem, repsonsible for maintaining / managing entire deployment and seeking vendor support for issues}
        \item {Provide Application Support on rotational-shift basis}
      \end{cvitems}
    }
