...
%---------------------------------------------------------
  \cventry
    {Systems Specialist - Platform Application Services (Schedulers and Orchestrators)} % Job title
  ...
  \cventry
    {Systems Specialist - Platform Application Services (Developer Tools / Platforms)} % Job title
    {}
    {}
